...
class MaterialTheme {
  ...
  static ColorScheme lightScheme() {
    return const ColorScheme(
      ...
      primary: Color(0xFF1A8FE2),
      // surfaceTint: Color(0xFF00677F),
      onPrimary: Color(0xFFFFFFFF),
      primaryContainer: Color(0xFFD0E1F1),
      onPrimaryContainer: Color(0xFF0E5F99),
      secondary: Color(0xFF3E6471),
      onSecondary: Color(0xFF1A8FE2),
      secondaryContainer: Color(0xFFD0E1F1),
      onSecondaryContainer: Color(0xFF0E5F99),
      ...
      outlineVariant: Color(0xFFDADEE2),
  ...
  static const success = ExtendedColor(
    seed: Color(0xFF00BA37),
    value: Color(0xFF00BA37),
    light: ColorFamily(
